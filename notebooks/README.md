...
| 1 | `01_features.ipynb` | Стейтлес-фічі + стіна проти витоку |
| 2 | `02_labels.ipynb` | Мітка within-creator (пороги на train) |
| 3 | `03_data_prep.ipynb` | Завантаження → очистка → темпоральний спліт → фічі |
...
> ⚠️ Зміна формату проти ТЗ: вихідне ТЗ вимагало `.py`-модулі + pytest + Streamlit. За
